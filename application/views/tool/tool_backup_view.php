    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Klik tombol <b>Backup Database</b> untuk melakukan Backup database CBT. Simpan backup database pada tempat yang aman.</p>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header with-border">
                        <div class="card-title">Backup Data Upload</div>
                    </div><!-- /.card-header -->

                    <div class="card-body">
                        <span id="form-pesan-data-upload"></span>
                        <p>Klik tombol <b>Backup Data Upload</b> untuk melakukan Backup Data yang di Upload (gambar, audio) pada CBT. Simpan backup data pada tempat yang aman.</p>
                        <p>Data file yang di upload akan disimpan dalam bentuk archive.</p>
                        <p>Restore Data Upload dilakukan dengan meng-copy data ke folder uploads pada folder utama CBT</p>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header with-border">
                        <div class="card-title">Clear Sessions</div>
                    </div><!-- /.card-header -->

                    <div class="card-body">
                        <span id="form-pesan-database"></span>
                        <p>Klik tombol <b>Clear Sessions</b> untuk membersihkan sessions peserta tes yang disimpan di tabel cbt_sessions.</p>
                        <p>Setelah CBT digunakan dalam waktu yang lama dan menjalan banyak TES, maka session harus dibersikan.</p>
