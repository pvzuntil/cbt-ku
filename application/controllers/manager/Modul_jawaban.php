	...
	function get_datatable()
	{
		...
		foreach ($query as $temp) {
			...
			$record[] = '<div style="text-align: center;">
            	<a onclick="edit(\'' . $temp->jawaban_id . '\')" title="Edit Jawaban" style="cursor: pointer;" class="btn btn-sm btn-info text-white"><span class="fas fa-pen"></span></a>
            	<a onclick="hapus(\'' . $temp->jawaban_id . '\')" title="Hapus Jawaban" style="cursor: pointer;" class="btn btn-sm btn-danger text-white"><span class="fas fa-trash"></span></a>
            	</div>
            ';
